...
public abstract class ResultHandler {
  ...
  /*
  final void sendPost(String contents) {
	   
	  HttpClient httpclient = new DefaultHttpClient();
	  HttpPost httppost = new HttpPost("http://dev.sertal.ch:7500/code");

	    try {
	        // Add your data
	        List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
	        nameValuePairs.add(new BasicNameValuePair("id", contents));
...
*/
 ...
 // private static final String TAG = "samplePostResult";
  ...
  //  sendSMSFromUri("smsto:", activity.getString(R.string.msg_share_subject_line) + ":\n" +
    //    contents);
	 ...
	 // System.out.println(contents);
	  HttpClient httpclient = new DefaultHttpClient();
	  HttpPost httppost = new HttpPost("http://dev.sertal.ch:8000/code");
	  
	  Log.i(TAG, "inside result handler: " + contents);
	    ...
	    try {
	        ...
	        if(entity != null)
	        {
	        	...
	        	if(responseBody!=""){
	        		...
	        		String displayText = responseBody + " sent successfully";
	        		Toast.makeText(activity, displayText, Toast.LENGTH_LONG).show();
	        	
	        	} else {
	        		
	        		Toast.makeText(activity, R.string.msg_intent_failed, Toast.LENGTH_LONG).show();
	        		Log.i(TAG, "failed: " + entity);
	        		
	        	}
	        	Log.i(TAG, "after the post: inside entity:  " + responseBody);
        		...
        		Toast.makeText(activity, R.string.msg_intent_failed, Toast.LENGTH_LONG).show();
        		Log.i(TAG, "entity null : " + entity);
        		
        	}
	        
	    } catch (ClientProtocolException e) {
	        // TODO Auto-generated catch block
	    	Log.i(TAG, "inside try client protocol expception: ");
	    	Toast.makeText(activity, R.string.msg_intent_failed1, Toast.LENGTH_LONG).show();
	    } catch (IOException e) {
	        // TODO Auto-generated catch block
	    	Toast.makeText(activity, R.string.msg_intent_failed1, Toast.LENGTH_LONG).show();
	    	Log.i(TAG, "inside try IO exception: ");
